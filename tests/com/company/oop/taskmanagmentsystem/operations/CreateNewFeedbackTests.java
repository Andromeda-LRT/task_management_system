...
import com.company.oop.taskmanagementsystem.commands.create.CreateNewFeedback;
...
public class CreateNewFeedbackTests {
    ...
    public void initCreateFeedbackInBoardCommand(){
        ...
        command = new CreateNewFeedback(taskManagementSystemRepository);
    ...
    public void execute_Should_CreateBugInBoardCommand_When_ValidParameters(){
        ...
        Assertions.assertEquals(String.format(CreateNewFeedback.FEEDBACK_CREATED_SUCCESSFULLY,
