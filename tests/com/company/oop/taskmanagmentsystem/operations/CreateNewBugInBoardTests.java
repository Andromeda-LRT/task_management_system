...
import com.company.oop.taskmanagementsystem.commands.CreateNewBugInBoard;
...
public class CreateNewBugInBoardTests {
    ...
    public void initCreateBugInBoardCommand(){
        ...
        command = new CreateNewBugInBoard(taskManagementSystemRepository);
    ...
    public void execute_Should_CreateBugInBoardCommand_When_ValidParameters(){
        ...
        Assertions.assertEquals(String.format(CreateNewBugInBoard.BUG_CREATED_SUCCESSFULLY,
